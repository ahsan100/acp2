...
install("kadira:blaze-layout");                                              // 77
install("erasaur:meteor-lodash");                                            // 78
install("mquandalle:stylus");                                                // 79
install("fortawesome:fontawesome");                                          // 80
install("callback-hook");                                                    // 81
install("spiderable");                                                       // 82
install("fastclick");                                                        // 83
install("ui");                                                               // 84
install("session");                                                          // 85
install("raix:handlebar-helpers");                                           // 86
install("aldeed:simple-schema");                                             // 87
install("raix:eventemitter");                                                // 88
install("aldeed:collection2-core");                                          // 89
install("aldeed:schema-index");                                              // 90
install("aldeed:schema-deny");                                               // 91
install("aldeed:collection2");                                               // 92
install("livedata");                                                         // 93
install("momentjs:moment");                                                  // 94
install("aldeed:autoform");                                                  // 95
...
install("less");                                                             // 103
install("accounts-ui-unstyled");                                             // 104
install("accounts-ui");                                                      // 105
install("matb33:bootstrap-base");                                            // 106
install("matb33:bootstrap-glyphicons");                                      // 107
install("coffeescript");                                                     // 108
install("zimme:active-route");                                               // 109
install("gwendall:auth-client-callbacks");                                   // 110
...
install("datariot:ganalytics");                                              // 128
install("twbs:bootstrap");                                                   // 129
install("steeve:jquery-qrcode");                                             // 130
install("webapp");                                                           // 131
